document.addEventListener("DOMContentLoaded", function () {
    ...
    const commands = {
        ...
        "server": '<ul><li>My Discord server M<span class="chronic">X</span>S : Mini games server powered entirely by a Mr X (bot). To join click : <a href="https://discord.gg/2nMGz5zyXM" target="_blank" class="disc"><i class="fa-brands fa-discord"></i></a></li></ul>',
